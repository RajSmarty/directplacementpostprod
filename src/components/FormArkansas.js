        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              ...
              <h2 style={{ fontSize: "100%" }}>City:- <span style={{ fontWeight: "bold" }}>Arkansas</span></h2>
            </div>
          </div>
        </div>
      </div>
